...
export default function Hero() {
    ...
    return (
        <section className="relative mx-auto max-w-[1080px] h-[calc(100vh-13.65rem)] md:h-[calc(100vh-9.65rem)] w-full flex flex-col items-center md:justify-center overflow-hidden bg-white mt-5 md:mt-[20px]">
