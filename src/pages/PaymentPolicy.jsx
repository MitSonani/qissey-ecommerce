        ...
        <div className="min-h-screen bg-white text-[#1A1A1A] font-sans pt-24 md:pt-32 pb-20 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12">
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Payment & Invoices Policy</p>
                    ...
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Payment Options</p>
                        <div className="text-[13px] opacity-80 space-y-4 leading-relaxed font-medium">
                    ...
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Payment Security</p>
                        <div className="text-[13px] opacity-80 space-y-4 leading-relaxed font-medium">
                    ...
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Invoices</p>
                        <div className="text-[13px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <p>
                    ...
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Failed Transactions</p>
                        <div className="text-[13px] opacity-80 space-y-4 leading-relaxed font-medium">
                    ...
                    <section>
                        <p className="text-[14px] uppercase font-bold tracking-[0.1em] mb-4">Need Assistance?</p>
                        <div className="text-[13px] opacity-80 space-y-4 leading-relaxed font-medium">
