        ...
        <div className="min-h-screen bg-white text-[#1A1A1A] font-sans pt-24 md:pt-32 pb-20 px-6 md:px-12 lg:px-24">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-12">
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Acceptance of Terms</p>
                    ...
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Product Information & Pricing</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                    ...
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Orders & Acceptance</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Payments</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <p>
                            ...
                            <p>
                                For more information, please review our <Link to="/payment-policy" className="underline hover:text-black transition-colors">Payment Policy</Link>.
                            </p>
                        </div>
                    </section>

                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Shipping & Delivery</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <p>
                    ...
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Limitation of Liability</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <p>
                    ...
                    <section>
                        <p className="text-[16px] uppercase font-bold tracking-[0.1em] mb-4">Governing Law</p>
                        <div className="text-[15px] opacity-80 space-y-4 leading-relaxed font-medium">
                            <p>
